...
class SubspaceMethod(object):
    ...
    def calculate_covariance(
            self, X: np.ndarray, mode: str = "sample"):
        """
        Calculates the covariance matrix based on the specified mode.
        ...
        -----
            ...
            mode (str): Covariance calculation mode. Options: "spatial_smoothing", "sample".
...
class MUSIC(SubspaceMethod):
    ...
    --------
        ...
        narrowband(self, X, known_num_of_sources=True, mode: str="sample"):
        ...
        get_spectrum_peaks(spectrum: np.ndarray):
    ...
    def __init__(self, system_model: SystemModel):
        ...
        self._angels = np.linspace(-1 * np.pi / 2,
    ...
    @staticmethod
    def get_spectrum_peaks(spectrum: np.ndarray):
        """
        Calculates the peaks of the MUSIC spectrum.
...
class Esprit(RootMUSIC):
    ...
    def narrowband(
        ...
        doa_predictions = -1 * \
            self.extract_predictions_from_roots(phi_eigenvalues)[0]
...
class MVDR(MUSIC):
    ...
    Methods:
    narrowband(self, X:np.ndarray, mode: str="sample", eps:float = 1):
