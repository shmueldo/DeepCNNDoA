...
class SystemModelParams:
    ...
    def __init__(self):
        ...
        Returns:
            None
        """
        self.M = 2  # Number of sources
        self.N = 8  # Number of sensors
        self.T = 200  # Number of observations
        ...
        self.signal_nature = "non-coherent"  # Signal nature ("non-coherent" or "coherent")
